...
SCRAPE_DIR=${SCRAPE_DIR:-/var/lib/prometheus/node-exporter}

while true; do
    generate_output > ${SCRAPE_DIR}/smartmon.prom.tmp
    mv ${SCRAPE_DIR}/smartmon.prom.tmp ${SCRAPE_DIR}/smartmon.prom
    sleep 300
done
